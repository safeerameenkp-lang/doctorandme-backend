...
type Appointment struct {
	...
	ClinicPatientID  *string   `json:"clinic_patient_id,omitempty" db:"clinic_patient_id"`
...
type PatientVitals struct {
	ID              string    `json:"id" db:"id"`
	AppointmentID   string    `json:"appointment_id" db:"appointment_id"`
	ClinicPatientID string    `json:"clinic_patient_id" db:"clinic_patient_id"`
	...
	RespBPM         *int      `json:"resp_bpm" db:"resp_bpm"`
	Spo2Percent     *int      `json:"spo2_percent" db:"spo2_percent"`
	SugarMgdl       *float64  `json:"sugar_mgdl" db:"sugar_mgdl"`
	...
	SmokingStatus   *string   `json:"smoking_status" db:"smoking_status"`
	AlcoholUse      *string   `json:"alcohol_use" db:"alcohol_use"`
