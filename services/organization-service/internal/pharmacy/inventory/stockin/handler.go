...
func (h *Handler) Create(c *gin.Context) {
	...
	purchase, err := h.svc.AddStockIn(c.Request.Context(), pharmacyID, userID, userName, req)
	if err != nil {
		h.respondError(c, http.StatusInternalServerError, err.Error())
		return
	}

	h.respondJSON(c, http.StatusCreated, purchase)
}
...
func (h *Handler) GetByID(c *gin.Context) {
	...
	purchase, items, err := h.svc.GetStockInDetails(c.Request.Context(), pharmacyID, id)
	if err != nil {
		h.respondError(c, http.StatusInternalServerError, err.Error())
		return
	}
...
func (h *Handler) GetStats(c *gin.Context) {
	...
	stats, err := h.svc.GetStockInStats(c.Request.Context(), pharmacyID)
	if err != nil {
		h.respondError(c, http.StatusInternalServerError, err.Error())
		return
	}
...
func (h *Handler) List(c *gin.Context) {
	...
	purchases, total, err := h.svc.ListStockIn(c.Request.Context(), pharmacyID, page, pageSize)
	if err != nil {
		h.respondError(c, http.StatusInternalServerError, err.Error())
		return
	}
...
func (h *Handler) GetHistory(c *gin.Context) {
	...
	history, err := h.svc.GetStockInHistory(c.Request.Context(), id, pharmacyID)
	if err != nil {
		h.respondError(c, http.StatusInternalServerError, err.Error())
		return
	}
