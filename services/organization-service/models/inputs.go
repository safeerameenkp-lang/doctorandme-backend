...
// CreatePharmacyInput defines the input structure for creating a pharmacy
type CreatePharmacyInput struct {
	OrganizationID string  `json:"organization_id" form:"organization_id" binding:"required,uuid"`
	ClinicID       *string `json:"clinic_id" form:"clinic_id" binding:"omitempty,uuid"`
	UserID         string  `json:"user_id" form:"user_id" binding:"required,uuid"`
	PharmacyCode   *string `json:"pharmacy_code" form:"pharmacy_code" binding:"omitempty,min=2,max=20"` // Optional, auto-generated if empty
	Name           string  `json:"name" form:"name" binding:"required,min=1,max=255"`
	PharmacyType   string  `json:"pharmacy_type" form:"pharmacy_type" binding:"required,max=50"`
	Email          *string `json:"email" form:"email" binding:"omitempty,email"`
	Phone          *string `json:"phone" form:"phone" binding:"omitempty,len=10"`
	Address        *string `json:"address" form:"address" binding:"omitempty,max=500"`
	LicenseNumber  *string `json:"license_number" form:"license_number" binding:"omitempty,max=100"`
...
// CreatePharmacyWithAdminInput defines the input structure for creating a pharmacy with a new admin
type CreatePharmacyWithAdminInput struct {
	OrganizationID string  `json:"organization_id" form:"organization_id" binding:"required,uuid"`
	ClinicID       *string `json:"clinic_id" form:"clinic_id" binding:"omitempty,uuid"`
	PharmacyCode   *string `json:"pharmacy_code" form:"pharmacy_code" binding:"omitempty,min=2,max=20"` // Optional, auto-generated if empty
	Name           string  `json:"name" form:"name" binding:"required,min=1,max=255"`
...
// UpdatePharmacyInput defines fields for updating a pharmacy
type UpdatePharmacyInput struct {
	ClinicID      *string `json:"clinic_id" form:"clinic_id" binding:"omitempty,uuid"`
	PharmacyCode  *string `json:"pharmacy_code" form:"pharmacy_code" binding:"omitempty,min=2,max=20"`
	Name          *string `json:"name" form:"name" binding:"omitempty,min=1,max=255"`
	PharmacyType  *string `json:"pharmacy_type" form:"pharmacy_type" binding:"omitempty,max=50"`
	Email         *string `json:"email" form:"email" binding:"omitempty,email"`
	Phone         *string `json:"phone" form:"phone" binding:"omitempty,len=10"`
	Address       *string `json:"address" form:"address" binding:"omitempty,max=500"`
	LicenseNumber *string `json:"license_number" form:"license_number" binding:"omitempty,max=100"`
...
// CreateClinicPharmacyLinkInput defines inputs for linking a clinic with a pharmacy
type CreateClinicPharmacyLinkInput struct {
	ClinicID   string `json:"clinic_id" binding:"required,uuid"`
	PharmacyID string `json:"pharmacy_id" binding:"required,uuid"`
}
